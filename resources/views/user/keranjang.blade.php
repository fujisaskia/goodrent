        ...
        <div class="flex flex-col lg:flex-row space-x-4">
            <div class="flex-1 space-y-2 mx-4">
                ...
                <div
                    ...
                    <!-- Gambar produk -->
                    <img src="https://i.pinimg.com/736x/38/7a/74/387a74d7d7cc5f4c17b60b99453bf653.jpg" alt="Foto Produk"
                ...
                <!-- ITEM 2 -->
                <div
                    class="flex items-start space-x-3 p-4 rounded-none shadow-sm bg-white border-b border-gray-200 hover:bg-gray-50 duration-200">

                    <!-- Gambar produk -->
                    <img src="{{ asset('assets/kabel.png') }}" alt="Foto Produk"
                        class="w-20 h-20 rounded border border-gray-300" />
                ...
                <!-- ITEM 3 -->
                <div
                    class="flex items-start space-x-3 p-4 rounded-b-lg shadow-sm bg-white border-b border-gray-200 hover:bg-gray-50 duration-200">
                ...
                <div
                    ...
                    <img src="https://i.pinimg.com/736x/38/7a/74/387a74d7d7cc5f4c17b60b99453bf653.jpg"
                        alt="Foto Produk" class="w-20 h-20 rounded border border-gray-300" />
                    ...
                    <div class="flex-1">
                        <div class="flex space-x-3 justify-center items-center">
                            <div class="flex-1">
                                <!-- Nama Produk -->
                                <h3 class="font-semibold">Play station 6</h3>
                                <!-- Tanggal Sewa -->
                                <p class="text-xs text-gray-700">
                                    06 Maret, 2025 - 07 Maret, 2025
                                </p>
                ...
                <div
                    ...
                    <div class="flex flex-row md:flex-col justify-between">
                        <div class="flex space-x-2 justify-between items-center mt-3 md:pb-3 border-b">
                            ...
                            <span class="text-black font-bold text-lg">Rp103,632,000</span>
                        </div>
