    ...
    <nav class="fixed top-2 left-0 w-[calc(100%-2rem)] mx-4 bg-white shadow-md p-4 z-50 rounded-lg">
        <div class="max-w-6xl mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3 md:space-x-6">
                <div class="bg-slate-200 hover:bg-slate-300 rounded-full p-1.5">
                ...
                <div class="relative">
                    ...
                    <!-- Dropdown Menu -->
                    <div id="userMenu"
                        class="absolute right-0 mt-2 w-40 bg-white shadow-md border border-gray-300 rounded-lg hidden">
                        <ul class="py-2 text-sm text-gray-700">
                            <li><a href="#" class="flex space-x-3 px-4 py-2 hover:bg-gray-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
