    ...
    <div id="modal-overlay-tambah-diskon"
        ...
        <div id="modal-tambah-diskon"
            class="w-full max-w-2xl md:w-[600px] mx-auto p-6 bg-white rounded-lg shadow-lg border border-gray-400 md:border-none transform scale-95 opacity-0 transition-all duration-300">
