...
@section('content')
    ...
    <div class="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-lg border border-gray-400 md:border-none">
        <h1 class="text-xl font-semibold mb-6 pb-2 border-b text-center">Profil</h1>
